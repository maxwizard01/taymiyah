...
"Maths JSS1":[
    ...
    Option: {a:' Twenty thousand, eleven ten',
    ...
    {Question:'What is the positive difference between the LCM and HCF of 6,12, and 15?',
    Option: {a:' 57',
              b: '60',
              c:' 61',
              d:' 27 '},
    ...
    {Question:"A class contain 24boys and 26girls. On a certain day 6boys and 4girls were absent. What fraction of the',class was absent on that day?", 
    Option: {a:'  3/5',
              b: '2/3',
              c:' 3/5',
              d:' 4/5 '},
    ...
    {Question:'Of 160 oranges in a basket, 40 of them were bad. What percentage of the orange was good',
    Option: {a:' 60%',
    'b': '25%',
    c:' 75%',
    d:' 80%'},
    ...
    {Question:'Tony and Joy Shared 49mangoes in the ratio of 3:4. How many mango(es) did Joy receives more than Tony ',
    Option: {a:' 1',
              b: '7',
              c:' 21',
              d:'28'},
    ...
    {Question:'How many minutes are there between 10:45 am and 2:05pm the same day? ',
    Option: {a:' 200minutes',
              b: '220minutes',
              c:' 360minutes',
              d:' 320minutes '},
    ...
    {Question:'If P=7, q=5 and r=3 find the value of p<sup>2</sup> + 2q<sup>2</sup> –r<sup>2</sup>',
    Option: {a:' 99',
              b: '90',
              c:' 82.',
              d:' 72'},
 ...
 {Question:'Find the value of y in the triangle ABC below if all measurement are in cm ',
    Option: {a:' 8cm',
              b: '4cm',
              c:' 16cm',
              d:' 12cm'},
 ...
 {Question:'Use the information provided in the diagram to find y ',
    ...
    {Question:'The area of a triangle is 72cm<sup>2</sup>, given that the base lenght is 18cm. Find the height of the triangle',
    Option: {a:' 8cm',
              b: '4cm',
              c:' 6cm',
              d:' 7cm'},
...
{Question:'calculate the area of a trapezium with parallel side 6cm and 8cm and height 14cm ',
    Option: {a:' 24cm2',
              b: '28cm2',
              c:' 98cm2',
              d:' 14cm2'},
